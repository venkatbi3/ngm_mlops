...
Opening a pull request will trigger a[workflow](../.github/workflows/ngm_mlops-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/staging/ngm_mlops/ngm_mlops-model)
* [Prod model in UC](https://adb-xxxx.xx.azuredatabricks.net/explore/data/models/prod/ngm_mlops/ngm_mlops-model)
. 
