...
git add README.md docs .gitignore ngm_mlops/resources/README.md
...
If you want to use different catalog names, please update the target names declared in the[ngm_mlops/databricks.yml](../ngm_mlops/databricks.yml) file.
...
Follow the instructions in [ngm_mlops/resources/README.md](../ngm_mlops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../ngm_mlops/resources/README.md)  to propose, test, and deploy
